      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16 relative z-10">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-semibold text-[#111] dark:text-[#e6edf3] mt-4 tracking-tight" style={{ letterSpacing: '-0.02em' }}>Create your account</h1>
            <p className="text-[#aaa] dark:text-[#484f58] text-sm mt-1">Free forever · No credit card needed</p>
          </div>
          ...
          <div className="bg-white dark:bg-[#161b22] border border-[#e8e4dc] dark:border-[#30363d] rounded-2xl p-6 sm:p-8 shadow-xl shadow-black/5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="text-xs font-semibold text-[#555] dark:text-[#8b949e]">Full name</label>
                <input type="text"
            ...
            <p className="text-center text-sm text-[#aaa] dark:text-[#484f58]">
              ...
              <Link to="/login" className="text-[#111] dark:text-[#e6edf3] hover:underline font-medium">Log in</Link>
            </p>
          </div>

          <div className="flex items-center justify-center gap-2 mt-5">
            <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse inline-block"></span>
            <span className="text-xs text-[#bbb] dark:text-[#484f58]">Join students already practising with AI</span>
          </div>
        </div>
      </div>
      <Footer />
