...
import { useAuth } from '../context/AuthContext'; // ✅ Corrected relative path to look out into your context folder structure
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 3. Now that the token is safely written, navigate smoothly forward!
      navigate('/home');
    } catch (err) {
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white border border-[#e8e4dc] rounded-2xl p-6 sm:p-8 shadow-xl shadow-black/5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="text-xs font-semibold text-[#555]">Email address</label>
                <input type="email" className="input mt-1 w-full" placeholder="you@example.com"
                  value={form.email}
              ...
              <div>
                ...
                <input type="password" className="input mt-1 w-full" placeholder="••••••••"
                  value={form.password}
            ...
            {/* Optional Registration Redirect Break */}
          ...
          {/* Secure Environment Badging Footer */}
