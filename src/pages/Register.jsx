...
//             </div>
//             <h1 className="text-2xl font-medium text-[#111] tracking-tight">Create account</h1>
//             <p className="text-[#aaa] text-sm mt-1">Free forever. No credit card needed.</p>
//           </div>
...
//               <Link to="/login" className="text-[#111] hover:underline font-medium">
//                 Log in
//               </Link>
//             </p>
//           </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white border border-[#e8e4dc] rounded-2xl p-6 sm:p-8 shadow-xl shadow-black/5">
            ...
            <p className="text-center text-sm text-[#aaa]">
              Already have an account?{' '}
              <Link to="/login" className="text-[#111] hover:underline font-medium">Log in</Link>
            </p>
          </div>

          <div className="flex items-center justify-center gap-2 mt-5">
            <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse inline-block"></span>
            <span className="text-xs text-[#bbb]">Join students already practising with AI</span>
          </div>
        </div>
      </div>
      <Footer />
